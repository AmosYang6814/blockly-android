 ...
 * and an arbitrary other view or fragment and generates Dart code.
 */
public class DartActivity extends AbstractBlocklyActivity {
    ...
    private static final LanguageDefinition DART_LANGUAGE_DEF
                ...
                public void onFinishCodeGeneration(final String generatedCode) {
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            DemoUtil.updateTextMinWidth(mGeneratedTextView, DartActivity.this);
                        }
                    });
                }
            };
