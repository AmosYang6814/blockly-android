...
!COMPILED && goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function () {
    ...
    for (var a = this, b = this.paused_; this.depsToLoad_.length && !b;) (function () {
        ...
        var f = {
            pause: function () {
                ...
                for (var b =
                    [], c = 0; c < a.loadingDeps_.length; c++) b.push(a.loadingDeps_[c]);
                return b
    ...
    if (goog.global.CLOSURE_IMPORT_SCRIPT) goog.global.CLOSURE_IMPORT_SCRIPT(this.path) ? a.loaded() : a.pause(); else if (goog.inHtmlDocument_()) {
        ...
        if (!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING && goog.isDocumentLoading_()) {
            ...
            goog.DebugLoader_.IS_OLD_IE_ ? (a.pause(), e.onreadystatechange = function () {
                if ("loaded" ==
                    e.readyState || "complete" == e.readyState) a.loaded(), a.resume()
            }) : e.onload = function () {
                e.onload = null;
                a.loaded()
            };
    ...
    goog.Dependency), goog.Es6ModuleDependency.prototype.load = function (a) {
    function b(a, b) {
    ...
    if (goog.global.CLOSURE_IMPORT_SCRIPT) goog.global.CLOSURE_IMPORT_SCRIPT(this.path) ?
    ...
    goog.Dependency.call(this, a, b, c, d, e);
    this.contents_ = null;
    this.lazyFetch_ = !goog.inHtmlDocument_() || !("noModule" in
    ...
    var e = this;
    if (goog.global.CLOSURE_IMPORT_SCRIPT) b(), this.contents_ &&
    goog.global.CLOSURE_IMPORT_SCRIPT("", this.contents_) ? (this.contents_ = null, a.loaded()) : a.pause(); else {
...
goog.html.SafeUrl.fromFacebookMessengerUrl = function (a) {
    goog.string.caseInsensitiveStartsWith(a, "fb-messenger://share") || (a = goog.html.SafeUrl.INNOCUOUS_STRING);
    return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
goog.html.SafeUrl.fromSmsUrl = function (a) {
    goog.string.caseInsensitiveStartsWith(a, "sms:") && goog.html.SafeUrl.isSmsUrlBodyValid_(a) || (a = goog.html.SafeUrl.INNOCUOUS_STRING);
    return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
...
goog.html.SafeHtml.htmlEscape = function (a) {
    ...
    return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.htmlEscape(a), c)
};
...
Blockly.Events.filter = function (a, b) {
    ...
    for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++) if (!g.isNull()) {
        ...
        k ? g.type == Blockly.Events.MOVE && k.index == f - 1 ? (l.newParentId = g.newParentId, l.newInputName = g.newInputName, l.newCoordinate = g.newCoordinate, k.index = f) : g.type == Blockly.Events.CHANGE && g.element == l.element && g.name == l.name ? l.newValue = g.newValue : g.type != Blockly.Events.UI || "click" != g.element || "commentOpen" !=
        l.element && "mutatorOpen" != l.element && "warningOpen" != l.element ? (e[h] = {
            event: g,
            index: 1
        }, d.push(g)) : l.newValue = g.newValue : (e[h] = {event: g, index: f}, d.push(g))
    }
...
Blockly.RenderedConnection.prototype.bumpAwayFrom_ = function (a) {
    if (!this.sourceBlock_.workspace.isDragging()) {
        ...
        if (!b.isInFlyout) {
            ...
            a = a.y_ + Blockly.SNAP_RADIUS + Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS) - this.y_;
            c && (a = -a);
            b.RTL &&
            (e = -e);
            b.moveBy(e, a);
...
Blockly.Options = function (a) {
    ...
    var l = !!a.rtl, n = a.horizontalLayout;
    void 0 === n && (n = !1);
    var m = a.toolboxPosition;
    m = "end" === m ? !1 : !0;
    m = n ? m ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : m ==
...
Blockly.Variables.allDeveloperVariables = function (a) {
    ...
    a = {};
    for (var c = 0; c < b.length; c++) {
        var d = b[c], e = d.getDeveloperVariables;
        ...
        if (e) for (d = e(), e = 0; e < d.length; e++) a[d[e]] = d[e]
    }
    b = [];
...
Blockly.VariablesDynamic.flyoutCategoryBlocks = function (a) {
    ...
    if (0 < a.length) {
        if (Blockly.Blocks.variables_set_dynamic) {
            var c = '<xml><block type="variables_set_dynamic" gap="24">' + Blockly.Variables.generateVariableFieldXmlString(a[0]) + "</block></xml>";
            c = Blockly.Xml.textToDom(c).firstChild;
            b.push(c)
        }
        if (Blockly.Blocks.variables_get_dynamic) for (var d = 0; c = a[d]; d++) c = '<xml><block type="variables_get_dynamic" gap="8">' + Blockly.Variables.generateVariableFieldXmlString(c) +
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function (a) {
    var b = this.workspace_, c = Blockly.utils.createSvgElement("svg", {id: "svg" + a}, this.svgGroup_),
        d = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomoutClipPath" + a}, c);
    Blockly.utils.createSvgElement("rect", {width: 32, height: 32, y: 77}, d);
    ...
    a.setAttributeNS("http://www.w3.org/1999/xlink",
        "xlink:href", b.options.pathToMedia + Blockly.SPRITE.url);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function (a) {
    var b = this.workspace_, c = Blockly.utils.createSvgElement("svg", {id: "svg" + a}, this.svgGroup_),
        d = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoominClipPath" + a}, c);
    Blockly.utils.createSvgElement("rect", {width: 32, height: 32, y: 43}, d);
    a = Blockly.utils.createSvgElement("image", {
        width: Blockly.SPRITE.width,
        height: Blockly.SPRITE.height,
        x: -32,
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function (a) {
    var b = this.workspace_, c = Blockly.utils.createSvgElement("svg", {id: "svg" + a}, this.svgGroup_),
        d = Blockly.utils.createSvgElement("clipPath", {id: "blocklyZoomresetClipPath" + a}, c);
    Blockly.utils.createSvgElement("rect", {width: 32, height: 32}, d);
    a = Blockly.utils.createSvgElement("image", {
        width: Blockly.SPRITE.width,
        height: Blockly.SPRITE.height,
        y: -92,
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
    ...
    this.isFlyout || (Blockly.bindEventWithChecks_(this.svgGroup_, "mousedown", this, this.onMouseDown_, !1, !0), this.options.zoomOptions && this.options.zoomOptions.wheel && Blockly.bindEventWithChecks_(this.svgGroup_, "wheel", this, this.onMouseWheel_));
    this.options.hasCategories && (this.toolbox_ =
        new Blockly.Toolbox(this));
...
Blockly.WorkspaceSvg.prototype.centerOnBlock = function (a) {
    if (this.scrollbar) {
        if (a = this.getBlockById(a)) {
            ...
            b = (b.y + c.height / 2) * d;
            c = this.getMetrics();
            a = a - c.contentLeft - c.viewWidth / 2;
            b = b - c.contentTop - c.viewHeight / 2;
            Blockly.hideChaff();
...
Blockly.Block.prototype.unplugFromRow_ = function (a) {
    ...
    b && a && (a = this.getOnlyValueConnection_()) && a.isConnected() && (a = a.targetConnection, a.checkType_(b) && (a.disconnect(), b.connect(a)))
};
Blockly.Block.prototype.getOnlyValueConnection_ = function () {
    for (var a = null, b = 0; b < this.inputList.length; b++) {
        ...
        if (c && c.type == Blockly.INPUT_VALUE) {
            if (a) return null;
            a = c
        }
    }
...
Blockly.Block.prototype.setColour = function (a) {
    ...
    if (!isNaN(c) && 0 <= c && 360 >= c) this.hue_ = c, this.colour_ = Blockly.hueToRgb(c); else if ("string" == typeof b && /^#[0-9a-fA-F]{6}$/.test(b)) this.colour_ = b, this.hue_ = null; else throw c = 'Invalid colour: "' + b + '"', a != b && (c += ' (from "' + a + '")'), c;
};
...
Blockly.Block.prototype.jsonInit = function (a) {
    ...
    "string" == typeof a.extensions && (console.warn(b + "JSON attribute 'extensions' should be an array of strings. Found raw string in JSON for '" + a.type + "' block."), a.extensions =
        [a.extensions]);
...
Blockly.Block.prototype.jsonInitColour_ = function (a, b) {
    if ("colour" in a) if (void 0 === a.colour) console.warn(b + "Undefined color value."); else {
        var c = a.colour;
        try {
            this.setColour(c)
        } catch (d) {
...
Blockly.BlockSvg.prototype.renderFields_ = function (a, b, c) {
    ...
    for (var d = 0, e; e = a[d]; d++) {
        var f = e.getSvgRoot();
        f && (this.RTL ? (b -= e.renderSep + e.renderWidth, f.setAttribute("transform", "translate(" + b + "," + c + ")"), e.renderWidth && (b -= Blockly.BlockSvg.SEP_SPACE_X)) : (f.setAttribute("transform", "translate(" + (b + e.renderSep) + "," + c + ")"), e.renderWidth && (b += e.renderSep + e.renderWidth + Blockly.BlockSvg.SEP_SPACE_X)), this.isInsertionMarker() && f.setAttribute("display", "none"))
    }
    return this.RTL ?
        -b : b
};
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), n = 0, m; m = b[n]; n++) if (m.isVisible()) {
        ...
        for (var r = 0, t; t = m.fieldRow[r]; r++) {
            ...
            t.renderSep = q && t.EDITABLE ? Blockly.BlockSvg.SEP_SPACE_X : 0;
...
Blockly.FieldColour.prototype.showEditor_ = function () {
    ...
    Blockly.WidgetDiv.DIV.appendChild(c);
    var d = goog.style.getSize(c);
    Blockly.WidgetDiv.positionWithAnchor(a, b, d, this.sourceBlock_.RTL);
    Blockly.FieldColour.onUpWrapper_ = Blockly.bindEvent_(c, "mouseup", this, this.onClick_)
};
...
Blockly.FieldImage.prototype.init = function () {
    ...
    }, this.fieldGroup_), this.setValue(this.src_), this.sourceBlock_.getSvgRoot().appendChild(this.fieldGroup_), this.tooltip_ ? this.imageElement_.tooltip = this.tooltip_ : this.setTooltip(this.sourceBlock_), Blockly.Tooltip.bindMouseEvents(this.imageElement_),
...
Blockly.Flyout.prototype.filterForCapacity_ = function () {
    for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++) -1 == this.permanentlyDisabled_.indexOf(c) && c.setDisabled(!this.targetWorkspace_.isCapacityAvailable(Blockly.utils.getBlockTypeCounts(c)))
};
...
Blockly.VerticalFlyout.prototype.position = function () {
    if (this.isVisible()) {
        ...
        if (a) {
            ...
            this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT && (this.leftEdge_ = c += a.viewWidth - this.width_);
...
Blockly.Toolbox.prototype.syncTrees_ = function (a, b, c) {
    for (var d = null, e = null, f = 0, g; g = a.childNodes[f]; f++) if (g.tagName) switch (g.tagName.toUpperCase()) {
        case "CATEGORY":
            ...
            k = Blockly.utils.replaceMessageReferences(g.getAttribute("colour"));
            null === k || "" === k ? h.hexColour = "" : /^#[0-9a-fA-F]{6}$/.test(k) ? (h.hexColour = k,
                this.hasColours_ = !0) : "number" === typeof k || "string" === typeof k && !isNaN(Number(k)) ? (h.hexColour = Blockly.hueToRgb(Number(k)), this.hasColours_ = !0) : (h.hexColour = "", console.warn('Toolbox category "' + e + '" has unrecognized colour attribute: ' + k));
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none", "}", ".blocklyNonSelectable {", "user-select: none;", "-moz-user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;",
    ...
    "stroke: #f00;", "stroke-width: 2;", "stroke-linecap: round;", "pointer-events: none;", "}", ".blocklyContextMenu {", "border-radius: 4px;", "}", ".blocklyDropdownMenu {", "padding: 0 !important;", "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;", "}", ".blocklyToolboxDiv {", "background-color: #ddd;", "overflow-x: visible;", "overflow-y: auto;", "position: absolute;",
    ...
    "background-position: -48px -1px;", "}", ".blocklyTreeLabel {", "cursor: default;", "font-family: sans-serif;", "font-size: 16px;", "padding: 0 3px;", "vertical-align: middle;", "}", ".blocklyToolboxDelete .blocklyTreeLabel {", 'cursor: url("<<<PATH>>>/handdelete.cur"), auto;', "}", ".blocklyTreeSelected .blocklyTreeLabel {", "color: #fff;", "}", ".blocklyColourTable {", "border-collapse: collapse;", "}", ".blocklyColourTable>tr>td {", "border: 1px solid #666;", "padding: 0;", "}", ".blocklyColourTable>tr>td>div {", "border: 1px solid #666;",
    ...
    "max-height: 100%;", "z-index: 20000;", "}", ".blocklyWidgetDiv .goog-menuitem {", "color: #000;", "font: normal 13px Arial, sans-serif;", "list-style: none;", "margin: 0;", "padding: 4px 7em 4px 28px;", "white-space: nowrap;", "}", ".blocklyWidgetDiv .goog-menuitem.goog-menuitem-rtl {", "padding-left: 7em;", "padding-right: 28px;", "}", ".blocklyWidgetDiv .goog-menu-nocheckbox .goog-menuitem,", ".blocklyWidgetDiv .goog-menu-noicon .goog-menuitem {", "padding-left: 12px;", "}", ".blocklyWidgetDiv .goog-menu-noaccel .goog-menuitem {",
    "padding-right: 20px;", "}", ".blocklyWidgetDiv .goog-menuitem-content {", "color: #000;", "font: normal 13px Arial, sans-serif;", "}", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-accel,", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-content {", "color: #ccc !important;", "}", ".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-icon {", "opacity: 0.3;", "filter: alpha(opacity=30);", "}", ".blocklyWidgetDiv .goog-menuitem-highlight,", ".blocklyWidgetDiv .goog-menuitem-hover {", "background-color: #d6e9f8;",
    "border-color: #d6e9f8;", "border-style: dotted;", "border-width: 1px 0;", "padding-bottom: 3px;", "padding-top: 3px;", "}", ".blocklyWidgetDiv .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-menuitem-icon {", "background-repeat: no-repeat;", "height: 16px;", "left: 6px;", "position: absolute;", "right: auto;", "vertical-align: middle;", "width: 16px;", "}", ".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-icon {", "left: auto;", "right: 6px;",
...
Blockly.createMainWorkspace_ = function (a, b, c, d) {
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function (a) {
        if (!e.isDragging()) {
            var c = e.getMetrics(), d = c.viewLeft + c.absoluteLeft, f = c.viewTop + c.absoluteTop;
            if (c.contentTop < f || c.contentTop +
                c.contentHeight > c.viewHeight + f || c.contentLeft < (b.RTL ? c.viewLeft : d) || c.contentLeft + c.contentWidth > (b.RTL ? c.viewWidth : c.viewWidth + d)) {
                var l = e.getTopBlocks(!1), n = null;
                a && (n = Blockly.Events.getGroup(), Blockly.Events.setGroup(a.group));
                for (var m = !1, p = 0, q; q = l[p]; p++) {
                    var r = q.getRelativeToSurfaceXY(), t = q.getHeightWidth(), u = f + 25 - t.height - r.y;
                    0 < u && (q.moveBy(0, u), m = !0);
                    u = f + c.viewHeight - 25 - r.y;
                    0 > u && (q.moveBy(0, u), m = !0);
                    u = 25 + d - r.x - (b.RTL ? 0 : t.width);
                    0 < u && (q.moveBy(u, 0), m = !0);
                    r = d + c.viewWidth - 25 - r.x + (b.RTL ? t.width :
                        0);
                    0 > r && (q.moveBy(r, 0), m = !0)
                }
                a && (!a.group && m && console.log("WARNING: Moved blocks in bounds but there was no event group. This may break undo."), Blockly.Events.setGroup(n))
            }
        }
    });
    Blockly.svgResize(e);
...
Blockly.init_ = function (a) {
    ...
    b.languageTree && (a.toolbox_ ? a.toolbox_.init(a) : a.flyout_ && (a.flyout_.init(a), a.flyout_.show(b.languageTree.childNodes), a.flyout_.scrollToStart(),
        a.scrollX = a.flyout_.width_, b.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1), a.translate(a.scrollX, 0)));
    ...
    if (!(b.options.readOnly || Blockly.utils.isTargetInput(a) || b.rendered && !b.isVisible())) {
        ...
        if (27 == a.keyCode) Blockly.hideChaff(); else if (8 == a.keyCode || 46 == a.keyCode) {
            ...
            Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(),
                Blockly.copy_(Blockly.selected)) : 88 != a.keyCode || Blockly.selected.workspace.isFlyout || (Blockly.copy_(Blockly.selected), c = !0));
        ...
        c && !Blockly.selected.workspace.isFlyout && (Blockly.Events.setGroup(!0),
            Blockly.hideChaff(), Blockly.selected.dispose(!0, !0), Blockly.Events.setGroup(!1))
    }
};
