...
Blockly.Blocks.procedures_defnoreturn = {
    init: function () {
        ...
        this.argumentVarModels_ = [];
        for (var b = 0, c; c =
            a.childNodes[b]; b++) if ("arg" == c.nodeName.toLowerCase()) {
        ...
        if (null !== a && (a = "TRUE" == a, this.hasStatements_ != a)) if (a) this.setStatements_(!0), Blockly.Mutator.reconnect(this.statementConnection_,
            this, "STACK"), this.statementConnection_ = null; else {
        ...
        this.updateParams_();
        if (this.mutator.isVisible()) for (var c =
